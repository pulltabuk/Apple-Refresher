...
2. Open the SQL editor and run, in order: `supabase-schema.sql`, then
   ...
   then `supabase-schema-update-11.sql`, then `supabase-schema-update-12.sql`, then `supabase-schema-update-13.sql`, then `supabase-schema-update-14.sql`, then `supabase-schema-update-15.sql`.
